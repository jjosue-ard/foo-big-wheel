...
namespace Assets.Scripts.Utils
{
    public class ReadWriteJSON
    {
        ...
        public static ReelStripDataModel ReadRecordsForPocketScenario(string fileName)
        {
            ReelStripDataModel result;            
            string filePath = Path.Combine(Application.streamingAssetsPath, "Recorded_Scenarios", fileName);
